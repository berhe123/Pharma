...
// Class: CLocalPurchaseOrderPayments
// ...
//
...
namespace Pharma
{
    class CLocalPurchaseOrderPayments
    {
        ...
        public CLocalPurchaseOrderPayments()
        {
            _ConnectionString = ConnectionString;
        }
        public CLocalPurchaseOrderPayments(int Id, string Purchaseorderguid, int Paymentreason, DateTime Paymentdate, string Referencenumber, decimal Amount)
        {
            _Id = Id;
        ...
        public DataTable GetRecord()
        {
            ...
            command.CommandText = "Select * from tblLocalPurchaseOrderPayments where Id=@Id";
            command.CommandType = CommandType.Text;
            DataTable dTable = new DataTable("tblLocalPurchaseOrderPayments");
            ...
            {
                throw new Exception("CLocalPurchaseOrderPayments::GetRecord::Error! " + ex.Message, ex);
            }
            finally
            {
        ...
        public DataTable GetRecords()
        {
            SqlConnection connection = new SqlConnection(_ConnectionString);
            SqlCommand command = new SqlCommand();
            command.CommandText = "Select * from tblLocalPurchaseOrderPayments";
            command.CommandType = CommandType.Text;
            DataTable dTable = new DataTable("tblLocalPurchaseOrderPayments");
            SqlDataAdapter adapter = new SqlDataAdapter(command);
            command.Connection = connection;
            ...
            {
                throw new Exception("CLocalPurchaseOrderPayments::GetRecords::Error! " + ex.Message, ex);
            }
            finally
            {
                if (connection != null) connection.Close();
        ...
        public DataTable GetRecords(string Purchaseorderguid)
        {
            SqlConnection connection = new SqlConnection(_ConnectionString);
            SqlCommand command = new SqlCommand();
            command.CommandText = "Select * from tblLocalPurchaseOrderPayments where PurchaseOrderGuid=@PurchaseOrderGuid";
            command.CommandType = CommandType.Text;
            DataTable dTable = new DataTable("tblLocalPurchaseOrderPayments");
            SqlDataAdapter adapter = new SqlDataAdapter(command);
            command.Connection = connection;
        ...
        public bool Insert()
        {
            SqlConnection connection = new SqlConnection(_ConnectionString);
            SqlCommand command = new SqlCommand();
            command.CommandText = "Insert Into tblLocalPurchaseOrderPayments" +
                                   " (PurchaseOrderGuid, " +
                                   " PaymentReason, " +
                                   " PaymentDate, " +
                                   " ReferenceNumber, " +
            ...
            {
                throw new Exception("CLocalPurchaseOrderPayments::Insert::Error! " + ex.Message, ex);
            }
            finally
            {
                if (connection != null) connection.Close();
        ...
        public bool Update()
        {
            SqlConnection connection = new SqlConnection(_ConnectionString);
            SqlCommand command = new SqlCommand();
            command.CommandText = "Update tblLocalPurchaseOrderPayments" +
            ...
            {
                throw new Exception("CLocalPurchaseOrderPayments::Update::Error! " + ex.Message, ex);
            }
            finally
            {
                if (connection != null) connection.Close();
        ...
        public bool Delete()
        {
            SqlConnection connection = new SqlConnection(_ConnectionString);
            SqlCommand command = new SqlCommand();
            command.CommandText = "Delete From tblLocalPurchaseOrderPayments Where Id = @Id ";
            command.CommandType = CommandType.Text;
            command.Connection = connection;
            ...
            {
                throw new Exception("CLocalPurchaseOrderPayments::Delete::Error! " + ex.Message, ex);
            }
            finally
            {
                if (connection != null) connection.Close();
        ...
        public int Exists(bool bNew)
        {
            ...
            if (bNew)
                command.CommandText = "SELECT Id FROM [dbo].[tblLocalPurchaseOrderPayments] WHERE " +
            ...
            {
                throw new Exception("CLocalPurchaseOrderPayments::Exists::Error! " + ex.Message, ex);
            }
            finally
            {
                if (connection != null) connection.Close();
        ...
        public List<CLocalPurchaseOrderPayments> GetList()
        {
            List<CLocalPurchaseOrderPayments> RecordsList = new List<CLocalPurchaseOrderPayments>();
            SqlConnection connection = new SqlConnection(_ConnectionString);
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    CLocalPurchaseOrderPayments objCPurchaseOrderPayments = new CLocalPurchaseOrderPayments();
            ...
            {
                throw new Exception("CLocalPurchaseOrderPayments::GetList::Error! " + ex.Message, ex);
            }
            finally
            {
                if (connection != null) connection.Close();
        ...
        public List<CLocalPurchaseOrderPayments> GetList(string Purchaseorderguid)
       {
            List<CLocalPurchaseOrderPayments> RecordsList = new List<CLocalPurchaseOrderPayments>();
            SqlConnection connection = new SqlConnection(_ConnectionString);
            SqlDataReader dr = null;
        ...
        public static string GetTableRowGuid(int Id)
        {
            ...
            command.CommandText = "SELECT TableRowGuid FROM [dbo].[tblLocalPurchaseOrderPayments] WHERE Id = @Id";
            command.CommandType = CommandType.Text;
            command.Connection = connection;
            ...
            {
                throw new Exception("CLocalPurchaseOrderPayments::GetTableRowGuid::Error!" + ex.Message, ex);
            }
            finally
            {
                if (connection != null) connection.Close();
        ...
        public static int GetTableRowId(string Tablerowguid)
        {
            ...
            command.CommandText = "SELECT Id FROM [dbo].[tblLocalPurchaseOrderPayments] WHERE TableRowGuid = @TableRowGuid";
            command.CommandType = CommandType.Text;
            command.Connection = connection;
            ...
            {
                throw new Exception("CLocalPurchaseOrderPayments::GetTableRowId::Error!" + ex.Message, ex);
            }
            finally
            {
                if (connection != null) connection.Close();
