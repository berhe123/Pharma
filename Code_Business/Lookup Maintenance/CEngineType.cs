...
namespace Pharma
{
    class CEngineType
    {
        public static List<CEngineType> ItemCategoriesCollection = null;
        ...
        public CEngineType(int Id, string Name, int Categorytype)
        {
            _Id = Id;
            _Name = Name;
        }
        ...
        public DataTable GetRecord()
        {
            ...
            command.CommandText = "Select * from tblEngineType where Id=@Id";
            command.CommandType = CommandType.Text;
            DataTable dTable = new DataTable("tblEngineType");
        ...
        public DataTable GetRecords()
        {
            SqlConnection connection = new SqlConnection(_ConnectionString);
            SqlCommand command = new SqlCommand();
            command.CommandText = "Select * from tblEngineType";
            command.CommandType = CommandType.Text;
            DataTable dTable = new DataTable("tblEngineType");
            SqlDataAdapter adapter = new SqlDataAdapter(command);
            command.Connection = connection;
        ...
        public bool Insert()
        {
            SqlConnection connection = new SqlConnection(_ConnectionString);
            SqlCommand command = new SqlCommand();
            command.CommandText = "Insert Into tblEngineType" +
                                   " (Name,UserId,ComputerName,EventSource)" +
                                   " Values (@Name,@UserId,@ComputerName,@EventSource)" +
                                   " SELECT @Id=Max(id) from tblEngineType  ";
            command.CommandType = CommandType.Text;
            command.Connection = connection;
        ...
        public bool Update()
        {
            SqlConnection connection = new SqlConnection(_ConnectionString);
            SqlCommand command = new SqlCommand();
            command.CommandText = "Update tblEngineType" +
                                   " Set Name = @Name," +
                                   " UserId =@UserId," +
        ...
        public bool Delete()
        {
            SqlConnection connection = new SqlConnection(_ConnectionString);
            SqlCommand command = new SqlCommand();
            command.CommandText = "Delete From tblEngineType Where Id = @Id ";
            command.CommandType = CommandType.Text;
            command.Connection = connection;
        ...
        public int Exists(bool bNew)
        {
            ...
            if (bNew)
                command.CommandText = "SELECT Id FROM [dbo].[tblEngineType] WHERE " +
                                       " Name = @Name";
            else
                command.CommandText = "SELECT Id FROM [dbo].[tblEngineType] WHERE " +
                                       " Name = @Name " +
        ...
        public List<CEngineType> GetList()
        {
            List<CEngineType> RecordsList = new List<CEngineType>();
            SqlConnection connection = new SqlConnection(_ConnectionString);
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    CEngineType objCItemCategories = new CEngineType();
