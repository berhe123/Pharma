...
namespace Pharma
{
    class CModel
    {
        public static List<CModel> ItemCategoriesCollection = null;
        ...
        public CModel(int Id, string Name, int Categorytype)
        {
            _Id = Id;
            _Name = Name;
        }
        ...
        public DataTable GetRecord()
        {
            ...
            command.CommandText = "Select * from tblModel where Id=@Id";
            command.CommandType = CommandType.Text;
            DataTable dTable = new DataTable("tblModel");
        ...
        public DataTable GetRecords()
        {
            SqlConnection connection = new SqlConnection(_ConnectionString);
            SqlCommand command = new SqlCommand();
            command.CommandText = "Select * from tblModel";
            command.CommandType = CommandType.Text;
            DataTable dTable = new DataTable("tblModel");
            SqlDataAdapter adapter = new SqlDataAdapter(command);
            command.Connection = connection;
        ...
        public bool Update()
        {
            SqlConnection connection = new SqlConnection(_ConnectionString);
            SqlCommand command = new SqlCommand();
            command.CommandText = "Update tblModel" +
                                   " Set Name = @Name," +
                                   " UserId =@UserId," +
        ...
        public bool Delete()
        {
            SqlConnection connection = new SqlConnection(_ConnectionString);
            SqlCommand command = new SqlCommand();
            command.CommandText = "Delete From tblModel Where Id = @Id ";
            command.CommandType = CommandType.Text;
            command.Connection = connection;
        ...
        public int Exists(bool bNew)
        {
            ...
            if (bNew)
                command.CommandText = "SELECT Id FROM [dbo].[tblModel] WHERE " +
                                       " Name = @Name";
            else
                command.CommandText = "SELECT Id FROM [dbo].[tblModel] WHERE " +
                                       " Name = @Name " +
        ...
        {
            List<CModel> RecordsList = new List<CModel>();
            SqlConnection connection = new SqlConnection(_ConnectionString);
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    CModel objCItemCategories = new CModel();
