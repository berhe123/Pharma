...
namespace Pharma
{
    class CYears
    {
        public static List<CYears> ItemCategoriesCollection = null;
        ...
        public CYears(int Id, string Name, int Categorytype)
        {
            _Id = Id;
            _Name = Name;
        }
        ...
        public DataTable GetRecord()
        {
            ...
            command.CommandText = "Select * from tblYear where Id=@Id";
            command.CommandType = CommandType.Text;
            DataTable dTable = new DataTable("tblYear");
        ...
        public DataTable GetRecords()
        {
            SqlConnection connection = new SqlConnection(_ConnectionString);
            SqlCommand command = new SqlCommand();
            command.CommandText = "Select * from tblYear";
            command.CommandType = CommandType.Text;
            DataTable dTable = new DataTable("tblYear");
            SqlDataAdapter adapter = new SqlDataAdapter(command);
            command.Connection = connection;
        ...
        public bool Update()
        {
            SqlConnection connection = new SqlConnection(_ConnectionString);
            SqlCommand command = new SqlCommand();
            command.CommandText = "Update tblYear" +
                                   " Set Name = @Name," +
                                   " UserId =@UserId," +
        ...
        public bool Delete()
        {
            SqlConnection connection = new SqlConnection(_ConnectionString);
            SqlCommand command = new SqlCommand();
            command.CommandText = "Delete From tblYear Where Id = @Id ";
            command.CommandType = CommandType.Text;
            command.Connection = connection;
        ...
        public int Exists(bool bNew)
        {
            ...
            if (bNew)
                command.CommandText = "SELECT Id FROM [dbo].[tblYear] WHERE " +
                                       " Name = @Name";
            else
                command.CommandText = "SELECT Id FROM [dbo].[tblYear] WHERE " +
                                       " Name = @Name " +
        ...
        public List<CYears> GetList()
        {
            List<CYears> RecordsList = new List<CYears>();
            SqlConnection connection = new SqlConnection(_ConnectionString);
            ...
            try
            {
                ...
                while (dr.Read())
                {
                    CYears objCItemCategories = new CYears();
