...
namespace Pharma
{
    ...
    {
        private const string DialogCaption = "Damaged Items";
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                strCriteria = strCriteria + " And TransactionType = " + Convert.ToInt32(CCommon.StoreTransactionType.Damage);
        ...
        private bool SaveTransaction()
        {
            try
            {
                ...
                objTransactions.TransactionType = Convert.ToInt32(CCommon.StoreTransactionType.Damage);
        ...
        private bool IsValidTransaction()
        {
            try
            {
                ...
                {
                    CCommon.SetMessage(txtCheckedDate, "Please Enter Damage Date in a Correct Format", mValidator, lblMsg);
                    return false;
                }
        ...
        private void SaveTransactionDetail()
        {
            try
            {
                for (int grRow = 0; grRow < grvTransactionDetails.RowCount - 1; grRow++)
                {
                    ...
                    objTranDetail.Transactiontype = Convert.ToInt32(CCommon.StoreTransactionType.Damage);
