...
{
    /// <summary>
    /// Summary description for rptInvoicesListByItem.
    /// </summary>
    public partial class rptInvoicesListByItem : DataDynamics.ActiveReports.ActiveReport3
    {
        private const string DialogCaption = "List of Invoice by Item Report";
        ...
        private void groupHeader1_Format(object sender, EventArgs e)
        {
            try
            {
                ...
                txtProduct.Text = txtProduct.Text + " " + CCommon.GetDosageFormText(Convert.ToInt32(txtDosageForm.Value));
            }
            catch (Exception ex)
            {
                MessageBox.Show(ex.Message, DialogCaption, MessageBoxButtons.OK, MessageBoxIcon.Error);
