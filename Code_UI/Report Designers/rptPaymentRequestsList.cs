...
namespace Pharma
{
    ...
    /// </summary>
    public partial class rptPaymentRequestsList : DataDynamics.ActiveReports.ActiveReport3
    {
        private const string DialogCaption = "List of Payment Requests Report";
        ...
        private void pageHeader_Format(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    this.lblCriteria.Text += "Request Date: From " + _RequestDateFrom.ToString(CSettings.DateFormat)
