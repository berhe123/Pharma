...
{
    /// <summary>
    /// Summary description for rptStockCardWithInvoice.
    /// </summary>
    public partial class rptStockCardWithInvoice : DataDynamics.ActiveReports.ActiveReport3
    {
        private const string DialogCaption = "Stock Card with Invoice Report";
        ...
        public rptStockCardWithInvoice()
        {
            //
        ...
        public decimal GetBBF()
        {
            ...
            try
            {
                ...
                command.Parameters.Add(new SqlParameter("@UptoDate", _DateFrom.AddDays(-1))); // upto yesterday
        ...
        private void rptStockCard_ReportStart(object sender, EventArgs e)
        {
            try
            {
                ...
                txtAddress.Text = CSettings.OrganizationTelephone;
